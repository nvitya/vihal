...
#ifndef SRC_HWPWM_ATSAM_H_
#define SRC_HWPWM_ATSAM_H_

#define HWPWM_PRE_ONLY
#include "hwpwm.h"

class THwPwmChannel_atsam : public THwPwmChannel_pre
{
public:
...
#define HWPWM_IMPL THwPwmChannel_atsam

#endif /* SRC_HWPWM_ATSAM_H_ */
