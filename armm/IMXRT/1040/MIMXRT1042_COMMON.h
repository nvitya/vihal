...
#if !defined(MIMXRT1042_COMMON_H_)
#define MIMXRT1042_COMMON_H_                     /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  LPSPI3_IRQn                  = 35,               /**< LPSPI3 single interrupt vector for all sources */
  ...
  USB_PHY_IRQn                 = 65,               /**< USBPHY (UTMI0), Interrupt */
  ...
  FLEXSPI_IRQn                 = 108,              /**< FlexSPI interrupt */
  SEMC_IRQn                    = 109,              /**< SEMC interrupt */
  USDHC1_IRQn                  = 110,              /**< USDHC1 interrupt */
  USDHC2_IRQn                  = 111,              /**< USDHC2 interrupt */
  Reserved112_IRQn             = 112,              /**< Reserved interrupt */
  USB_OTG_IRQn                 = 113,              /**< USBO2 USB OTG */
...
#include "system_MIMXRT1042.h"         /* Device specific configuration file */
...
#define LPSPI3_BASE                              (0x403A0000u)
/** Peripheral LPSPI3 base pointer */
#define LPSPI3                                   ((LPSPI_Type *)LPSPI3_BASE)
/** Array initializer of LPSPI peripheral base addresses */
#define LPSPI_BASE_ADDRS                         { 0u, LPSPI1_BASE, LPSPI2_BASE, LPSPI3_BASE }
/** Array initializer of LPSPI peripheral base pointers */
#define LPSPI_BASE_PTRS                          { (LPSPI_Type *)0u, LPSPI1, LPSPI2, LPSPI3 }
/** Interrupt vectors for the LPSPI peripheral type */
#define LPSPI_IRQS                               { NotAvail_IRQn, LPSPI1_IRQn, LPSPI2_IRQn, LPSPI3_IRQn }
