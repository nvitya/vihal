...
#if !defined(XBARB_H_)
#define XBARB_H_                                 /**< Symbol preventing repeated inclusion */
...
typedef enum _xbar_output_signal
{
    ...
    kXBARA1_OutputLpspi4TrgInput    = 117|0x100U,  /**< XBARA1_OUT117 output assigned to LPSPI4_TRG_INPUT */
    kXBARA1_OutputLpspi3TrgInput    = 118|0x100U,  /**< XBARA1_OUT118 output assigned to LPSPI3_TRG_INPUT */
