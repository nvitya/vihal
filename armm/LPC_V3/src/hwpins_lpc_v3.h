...
#ifndef _HWPINS_LPC_V3_H
#define _HWPINS_LPC_V3_H

#define HWPINS_PRE_ONLY
#include "hwpins.h"

class THwPinCtrl_lpc_v3 : public THwPinCtrl_pre
{
public:
	// platform specific
...
class TGpioPort_lpc_v3 : public TGpioPort_pre
{
public:
...
class TGpioPin_lpc_v3 : public TGpioPin_common
{
public:
	HW_GPIO_REGS *   regs;
...
#define HWPINCTRL_IMPL   THwPinCtrl_lpc_v3
#define HWGPIOPORT_IMPL  TGpioPort_lpc_v3
#define HWGPIOPIN_IMPL   TGpioPin_lpc_v3

#endif /* HWPINS_LPC_V3_H_ */
