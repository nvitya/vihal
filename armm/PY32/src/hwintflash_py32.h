 ...
 * --------------------------------------------------------------------------- */
/*
 *  file:     hwintflash_py32.h
 *  brief:    Internal Flash Handling for PY32
 *  date:     2026-05-12
 *  authors:  nvitya
*/

#ifndef HWINTFLASH_PY32_H_
#define HWINTFLASH_PY32_H_

#define HWINTFLASH_PRE_ONLY
#include "hwintflash.h"

class THwIntFlash_py32 : public THwIntFlash_pre
{
public:
	bool             HwInit();
...
#define HWINTFLASH_IMPL     THwIntFlash_py32

#define HWINTFLASH_OWN_RUN

#endif // def HWINTFLASH_PY32_H_
