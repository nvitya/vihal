...
#ifndef SRC_HWPWM_PY32_H_
#define SRC_HWPWM_PY32_H_

#define HWPWM_PRE_ONLY
#include "hwpwm.h"

class THwPwmChannel_py32 : public THwPwmChannel_pre
{
public:
...
#define HWPWM_IMPL THwPwmChannel_py32

#endif /* SRC_HWPWM_PY32_H_ */
