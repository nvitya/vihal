 ...
 * --------------------------------------------------------------------------- */
// file:     hwuscounter_py32.h
// brief:    PY32 implementation of the us (microseconds) counter
// created:  2026-04-20
// authors:  nvitya
// notes:    uses the 32-bit TIM2

#ifndef HWUSCOUNTER_PY32_H_
#define HWUSCOUNTER_PY32_H_

#define HWUSCOUNTER_PRE_ONLY
#include "hwuscounter.h"

class THwUsCounter_py32 : public THwUsCounter_pre
{
public:
  int             timerdev = 2;  // 2 = TIM2
...
#define HWUSCOUNTER_IMPL THwUsCounter_py32

#endif // def HWUSCOUNTER_PY32_H_
