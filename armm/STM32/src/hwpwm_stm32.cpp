...
bool THwPwmChannel_stm32::Init(int atimernum, int achnum, int aoutnum) // outnum: 0 = A, 1 = B
{
  ...
  if (false)
  {
	...
	{
		regs = TIM15;
		APB2ENR_REGISTER |= RCC_APB2ENR_TIM15EN; //RCC_APBENR2_TIM15EN;
		advanced_timer = true;
    busid = 2;
	}
#endif
	...
	{
		regs = TIM16;
		APB2ENR_REGISTER |= RCC_APB2ENR_TIM16EN; //RCC_APBENR2_TIM16EN;
		advanced_timer = true;
    busid = 2;
	}
#endif
	...
	{
		regs = TIM17;
		APB2ENR_REGISTER |= RCC_APB2ENR_TIM17EN; //RCC_APBENR2_TIM17EN;
		advanced_timer = true;
    busid = 2;
	}
#endif
