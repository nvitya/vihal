 ...
 * --------------------------------------------------------------------------- */
// file:     armr_generic.h
// brief:    ARM Cortex-R Generic definitions
// created:  2024-06-16
// authors:  nvitya

#ifndef _ARMR_GENERIC_H_
#define _ARMR_GENERIC_H_
...
{
  unsigned prevstate = 0; //cpu_csr_read(CSR_MSTATUS);
  //cpu_csr_clrbits(CSR_MSTATUS, MSTATUS_MIE);  // clear machine interrupt enable bit
  return prevstate;
}
